...
const RoleCard: React.FC<{ 
  ...
  return (
    <button
      ...
      className={`relative flex flex-col items-center justify-center p-6 rounded-3xl border-2 transition-all duration-300 text-center overflow-hidden group ${
        isSelected 
    ...
    >
      ...
      <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 transition-colors duration-300 ${
        isSelected ? 'bg-primary-light text-white shadow-inner' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 group-hover:text-primary-light'
      }`}>
...
const FormInput: React.FC<{
  ...
  return (
    <div className="space-y-2">
      ...
      <div className={`relative flex items-center border-2 rounded-2xl transition-all duration-300 bg-white dark:bg-slate-950/50 ${
        focused ? 'border-primary-light shadow-[0_0_0_4px_rgba(254,119,67,0.1)]' : 
