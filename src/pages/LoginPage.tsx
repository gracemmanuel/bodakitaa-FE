          ...
          <div className="w-full lg:w-1/2 p-6 sm:p-10 md:p-16 flex flex-col justify-center bg-white dark:bg-slate-900/90 relative">
            ...
            <form onSubmit={handleLogin} className="space-y-6" noValidate>
              ...
              <div className="space-y-2 relative">
                ...
                <div className={`relative flex items-center border-2 rounded-2xl transition-all duration-300 bg-slate-50 dark:bg-slate-950/50 ${passwordFocused ? 'border-primary-light shadow-[0_0_0_4px_rgba(254,119,67,0.1)]' :
                    'border-slate-200 dark:border-slate-800'
                  }`}>
                  <div className="pl-4 pr-3 flex items-center justify-center pointer-events-none">
